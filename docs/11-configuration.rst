...
No. 2 extends this model rather than replacing it. The second quartet adds hand-specific piano parameters, separate piano occupancy, and more detailed chord controls. This is one of the clearest examples in the project of how technical design and musical design support each other.
