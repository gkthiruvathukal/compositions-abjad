...
This repository shows that programmatic composition can be treated as both an artistic workflow and a technical system.
The project already supports a complete path from source code to engraved score, MIDI, WAV, and published release output.
It also shows that finished work and exploratory work can live in the same codebase if the architecture is clear enough.

The main value of the repository is not only that it contains several scores.
